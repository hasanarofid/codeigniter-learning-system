	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 mx-auto">
				<img data-aos="fade-up" data-aos-duration="1800" src="<?= base_url('assets/') ?>img/new/ilus.png" alt="" srcset="">
			</div>
		</div>
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					...
					<a href="https://github.com/syauqi/Skybook"><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download Skybook <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
